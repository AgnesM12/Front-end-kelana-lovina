...
const PaketCard = ({ paket }) => {
    ...
    return (
    <div className="w-[320px] sm:w-[320px] md:w-[360px] lg:w-[385px] h-auto p-6 sm:p-5 lg:p-6 bg-white rounded-2xl shadow-[0px_6px_40px_0px_rgba(0,94,209,0.16)] overflow-hidden flex flex-col items-center justify-center transition-transform duration-300">
        <img className="w-full aspect-[1.2/1] object-cover object-center rounded-xl" src={paket.imageSrc} alt={paket.title} />
        <div className="p-4 sm:p-5 flex flex-col gap-3 text-center sm:text-left">
            <h3 className="text-xl sm:text-xl md:text-2xl font-bold object-center text-gray-900">{paket.title}</h3>
