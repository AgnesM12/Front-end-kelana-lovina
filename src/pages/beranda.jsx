    ...
    <main className="w-full max-w-7xl mx-auto px-6 sm:px-8 my-16 overflow-x-hidden ">
      ...
      <div className="relative w-full max-w-[1200px] aspect-[2.6/1] max-h-[458px] mx-auto pt-24 ">
        ...
        <img
          src="/Loogooo 1.png"
          alt="Logo Kelana"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11/12 max-w-[850px] h-auto"
        />
      </div>
...
export function GaleriPengunjung() {
  const judulGaleri = {
    ...
    description:
      "Kumpulan foto dan momen seru dari para pengunjung Pantai Lovina yang bisa menjadi inspirasi liburan Anda.",
  };
