        ...
        <div className="flex w-full h-screen bg-white">
            ...
            <div className="flex w-full md:w-1/2 lg:w-2/5 items-center justify-center bg-white p-6 sm:p-10">
                <div className="w-full max-w-md">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-zinc-800 text-center mb-3 sm:mb-4">
                        Daftar Sekarang!
                    </h2>
                    <p className="text-sm sm:text-base font-medium text-zinc-800 text-center mb-8 sm:mb-12">
                        Daftar sekarang dan mulai perjalanamu
                    </p>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        {/* EMAIL */}
                        <div>
                            <label className="block text-sm sm:text-base font-semibold text-zinc-800">
                                Alamat Email
                            </label>
                            <input
                                type="email"
                        ...
                        <div>
                            <div className="flex items-center">
                                <input
                                    ...
                                    type="checkbox"
                                    {...register("terms", {
                                        required: "Anda harus menyetujui ketentuan & privasi",
                                    })}
                                    className="h-4 w-4 sm:h-5 sm:w-5 mt-1 sm:mt-0 rounded border-gray-400 text-blue-600"
                                />
                                <label
                                    htmlFor="terms"
                                    className="ml-2 text-xs sm:text-sm font-semibold text-black"
                                >
                                    Saya menyetujui{" "}
                                    <a
                                        href="#"
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 sm:py-3.5 bg-blue-600 text-white text-sm sm:text-base font-bold rounded-lg hover:bg-blue-700 transition-colors"
                        >
                            Daftar
                        </button>
