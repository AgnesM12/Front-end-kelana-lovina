...
// import { reviewsMapping } from "../components/reviewPaket/reviewsMapping.jsx";
...
//     const reviews = ReviewComponent?.reviews || [];
...
function Ulasan() {
    ...
    // Gabungkan review statis dan dari localStorage
    const gabunganReview = [...staticReviews, ...userReview];
    const handleFilterChange = (value) => setFilter(value);

    // Map bulan ke angka untuk parse tanggal
    const bulanMap = {
        Januari: 0,
        Februari: 1,
        Maret: 2,
    ...
    .filter((r) => {
        ...
        .sort((a, b) => {
            ...
            return 0; // Default tidak di-sort
        });
